...
/**
 * print_version - This print the version of an ELF header.
...
/**
 * print_osabi - This print the OS/ABI of an ELF header.
 * @e_ident: This is a pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	m = read(g, header, sizeof(Elf64_Ehdr));
	if (m == -1)
	{
		free(header);
		close_elf(g);
