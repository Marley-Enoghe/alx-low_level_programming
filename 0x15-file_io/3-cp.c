...
* @err_cp_to: A function that checks for errors copied to
* @err_cp_from: This is A function that checks for errors copied from
* close_error - This is a function that is used to close errors in a file
* @argc: argument count
* @argv: argument vector
* check_error - used to check for error
