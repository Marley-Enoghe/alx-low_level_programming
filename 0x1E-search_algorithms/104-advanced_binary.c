...
/**
 * binary_search_recursion - The helper to `advanced_binary`, recursively searches
...
/**
 * advanced_binary - Used for searching  for a value in a sorted array of integers
