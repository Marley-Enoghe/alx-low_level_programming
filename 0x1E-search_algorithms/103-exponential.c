...
/**
 * min - Used to return the minimum of two size_t values
...
/**
 * binary_search_helper - For searching for a value in an integer array using a
 * binary search algorithm, Although not guaranteed to return lowest index if `value`
...
/**
 * exponential_search - For searching for a value in a sorted array of integers
