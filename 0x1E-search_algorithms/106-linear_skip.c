...
/**
 * linear_skip - Used to search for a value conatined in a skip list; assumes a
 ...
 * Return: This is a pointer on the first node where value is located, or NULL if list
